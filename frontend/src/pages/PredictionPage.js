    ...
    <div className="prediction-page">
      <div className="container">
        <div className="page-header text-center mb-4">
          <h1 className="page-title">Predict Dowry</h1>
          <p className="page-subtitle">Upload an image or enter appearance score to get dowry prediction</p>
        </div>
            ...
            <div className="col-md-6">
              <div className="card p-4">
                <form onSubmit={handleSubmit}>
                  ...
                  {/* OR Divider */}
                  <div className="or-divider text-center mb-3">
                    <span>OR</span>
                  </div>
            ...
            <div className="col-md-6">
              ...
              {prediction && (
                <div className="result-card">
                  ...
                  <div className="result-item">
                    ...
                    <span className="result-value">{prediction.probability_percentage || prediction.probability_high_dowry * 100}%</span>
                  </div>
              ...
              {!prediction && !error && !success && (
                <div className="card p-4 text-center">
                  ...
                  <h4 className="mt-2">No Prediction Yet</h4>
